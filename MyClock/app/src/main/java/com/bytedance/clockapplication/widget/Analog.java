...
public class Analog extends View {
    ...
    private final static String TAG = Analog.class.getSimpleName();
    ...
    public Analog(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        // todo 每一秒刷新一次，让指针动起来
        handler.postDelayed(() -> postInvalidate(), 1000);
    }
    ...
    private void drawPointer(Canvas canvas, int pointerType, float value) {
        ...
        switch (pointerType) {
            ...
            case 1:
                // todo 画分针，设置分针的颜色
                degree = value * UNIT_DEGREE;
                mNeedlePaint.setColor(Color.CYAN);
